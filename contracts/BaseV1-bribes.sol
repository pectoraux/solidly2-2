...
//     function getRewardForOwner(uint tokenId, address[] memory tokens) external lock returns(uint totalReward) {
...
//         require(msg.sender == factory, "Bribe deposit: Only factory");
//         checkIdentityProof(ve(_ve).ownerOf(tokenId), false);
//         totalSupply += amount;
...
//     function updateTeamShare(uint newShare) external {
...
//             _safeTransferFrom(token, msg.sender, devaddr_, teamShare);
