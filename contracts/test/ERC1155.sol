...
contract ERC1155_ is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function mint(address account, uint256 id, uint256 amount) external {
        _mint(account,id,amount,msg.data);
    }
     ...
     * acceptance magic value.
     */
    function _mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) public {
