...
// contract CharliesAngelsNFT is Auth, ERC1155Pausable, Percentile, ReentrancyGuard {
...
//     mapping(uint => uint) public paidReceivable;
//     struct AngelInfo {
//         uint active_period;
//         uint charlie;
//         uint paidPayable;
//         uint periodPayable;
//     }
//     mapping(address => AngelInfo) public angelInfo;
...
//         require(_to != msg.sender && _to != address(0), "Not an angel");

//         angelInfo[_to] = AngelInfo({
//             active_period: (block.timestamp + _periodPayable) / _periodPayable * _periodPayable,
//             charlie: _tokenId,
//             paidPayable: _paidPayable,
//             periodPayable: _periodPayable
//         });
//     }
...
//     ) external {
//         require(getReceiver(_tokenId) == msg.sender, "Only Receiver !");
//         require(angelInfo[_to].charlie == _tokenId, "Invalid tokenId");

//         angelInfo[_to].active_period = (block.timestamp + _periodPayable) / _periodPayable * _periodPayable;
//         angelInfo[_to].paidPayable = _paidPayable;
//         angelInfo[_to].periodPayable = _periodPayable;
//     }

//     function deleteAngel(
//         uint _tokenId,
//         address _to
//     ) external {
//         require(getReceiver(_tokenId) == msg.sender, "Only Receiver !");
...
//         delete angelInfo[_to];
//     }
    
//     function withdrawFromAngelAccount() external nonReentrant {
//         require(angelInfo[msg.sender].active_period <= block.timestamp, "Not due yet");
//         uint _tokenId = angelInfo[msg.sender].charlie;
//         require(paidReceivable[_tokenId] >= angelInfo[msg.sender].paidPayable, "Not enough fund");
//         paidReceivable[_tokenId] -= angelInfo[msg.sender].paidPayable;
//         _safeTransfer(
//             token,
//             msg.sender,
//             angelInfo[msg.sender].paidPayable
//         );
//         uint _periodPayable = angelInfo[msg.sender].periodPayable;
//         angelInfo[msg.sender].active_period = 
//         (block.timestamp + _periodPayable) / _periodPayable * _periodPayable;
//     }
...
//             paidReceivable[_tokenId] += _pendingBalance;
...
// contract CharliesAngelsNFTFactory {
...
//         last_baller = address(new CharliesAngelsNFT(
//             _devaddr,
//             _series,
//             _token,
//             _uri,
