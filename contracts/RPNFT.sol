...
// contract RPNFT is ERC1155Pausable, Ownable, ReentrancyGuard, Auth {
//     // State variables 
...
//         string last4Chars;
//         string extension;
//         string planet; // which planet
//         uint256 year; // which year it represents
//         string resource;
//         uint lockedTill;
//         uint lastUpdate;
//     }
...
//             _codes.length == _planets.length &&
//             _codes.length == _years.length,
//             "Invalid code lists"
...
//         uint[] memory _codes = new uint[](_numOfTickets);
//         string[] memory _first4Chars = new string[](_numOfTickets);
//         string[] memory _last4Chars = new string[](_numOfTickets);
//         string[] memory _extensions = new string[](_numOfTickets);
//         string[] memory _planets = new string[](_numOfTickets);
//         uint[] memory _years = new uint[](_numOfTickets);
//         return _batchMint(
//             _to, 
//             _codes, 
//             _first4Chars, 
...
//         if (ticketInfo_[_tokenId].year != 0 &&
//             keccak256(abi.encodePacked(ticketInfo_[_tokenId].resource)) == keccak256(abi.encodePacked(""))) {
...
//     function checkDeltas(uint256[] memory deltas) internal {
