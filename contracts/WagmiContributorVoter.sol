...
// contract WagmiContributorVoter {
...
//     //     require(_nft != address(0), "Contract cannot be 0 address");
//     //     nft_ = IBallerNFT(_nft);
//     // }
...
//             _tokenId
//         );
//         _attachTokenToGauge(_gauge, _bribe, _tokenId, _pool);
//         _updateFor(_gauge);
//         pools.push(_pool);
...
//             }
//         }
//         // if (msg.sender != minter) nft_.mint(msg.sender, amount);
...
//     // function _updateQuartiles() internal {
//     //     // score**2 + mean**2 - 2*score*mean 
//     //     uint mean = totalWeight / totalVote;
//     //     uint sum_of_diff_squared = totalWeightSquared + mean**2 - 2*totalWeight*mean;
//     //     uint std = Math.sqrt(sum_of_diff_squared / (totalVote>1?totalVote-1:1));
//     //     int256[] _quartiles = new int256[](4);
//     //     _quartiles[0](Q1_ZSCORE * std + mean);
//     //     _quartiles[1](Q2_ZSCORE * std + mean);
//     //     _quartiles[2](Q3_ZSCORE * std + mean);
//     //     _quartiles[3](Q4_ZSCORE * std + mean);

//     //     quartiles[lastUpdate] = _quartiles;
//     // }
