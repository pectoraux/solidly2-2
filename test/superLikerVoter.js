...
//     await gauge_factory.connect(owner2).vote(5, [pair.address], [5000]);
//     await gauge_factory.vote(1, [pair2.address], [5000]);
//     await gauge_factory.vote(4, [pair2.address], [500000]);
//     const pair_1000 = ethers.BigNumber.from("1000000000");
