...
describe("core", function () {
  ...
  it("deploy BaseV1Voter", async function () {
    ...
    const BaseV1Voter = await ethers.getContractFactory("WagmiBusinessVoter");
    gauge_factory = await BaseV1Voter.deploy(ve.address, gauges_factory.address, bribe_factory.address);
