...
describe("core", function () {
  ...
  it("deploy natural resource NFT", async function () {
  ...
  it("mint", async function () {
    expect(await naturalResourceNFT.totalSupply_()).to.equal(0);
    await ust.connect(owner2).approve(naturalResourceNFT.address, 20);
    await naturalResourceNFT.batchMint(owner2.address, 10, "oxygen", 2);
    console.log("pending round", await naturalResourceNFT.pendingRound(0));
    expect(await naturalResourceNFT.totalSupply_()).to.equal(0);
    await naturalResourceNFT.connect(owner2).setTicket(0, "oxygen", 2)
    console.log(await naturalResourceNFT.totalSupply_())
    console.log("pending round2", await naturalResourceNFT.pendingRound(0));
    console.log("ticket 1", await naturalResourceNFT.ticketInfo_(1));
    console.log("ticket 2", await naturalResourceNFT.ticketInfo_(2));
  });
